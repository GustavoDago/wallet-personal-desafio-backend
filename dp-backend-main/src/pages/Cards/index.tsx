...
interface CardFormValues extends FieldValues { // Define the shape of your form
  number: string;
  name: string;
  expiry: string;
  cvc: string;
          ...
          <div className="tw-flex tw-flex-col" id="PaymentForm">
            ...
            >
              <div>
                ...
                {errors.number && (
                  <ErrorMessage errors={errors.number as FieldError | undefined} />
                )}
              </div>
              <div>
                <FormControl variant="outlined">
                ...
                {errors.name && <ErrorMessage<CardFormValues> errors={errors.name} />}
              </div>
              <div>
                <FormControl variant="outlined">
                ...
                {errors.expiry && (
                  <ErrorMessage errors={errors.expiry as FieldError | undefined} />
                )}
              </div>
              <div>
                <FormControl variant="outlined">
